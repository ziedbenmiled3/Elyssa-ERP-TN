...
(async () => {
  ...
  console.log("Clicking Parc Auto...");
  ...
  console.log("Clicking Cession...");
  // Navigate to Cession
  await page.evaluate(() => {
    const btn = Array.from(document.querySelectorAll('button, a, div')).find(b => b.textContent && b.textContent.includes('Cession'));
    if(btn) btn.click();
  });
