...
const MOCK_AGENTS: FieldAgentLocation[] = [
  {
    ...
    role: 'Commercial IT (Van Sales)',
    vehicleRef: 'Camionette Isuzu (240 TN 8812)',
    status: 'SUR_SITE',
    lat: 36.8392,
    lng: 10.2432,
    address: 'Zone Industrielle Les Berges du Lac 2, Tunis',
    siteOrClientName: 'Client GEP - Dépôt Central',
    batteryLevel: 88,
    lastPunchTime: '08:15',
    lastPunchType: 'IN',
    speedKmH: 0,
  ...
  },
  {
    ...
    vehicleRef: 'Toyota Hilux (198 TN 4410)',
    status: 'SUR_SITE',
    lat: 35.8256,
    lng: 10.63699,
    address: 'Zone Portuaire, Sousse',
    siteOrClientName: 'Chantier Port de Sousse - Extension',
    batteryLevel: 64,
    lastPunchTime: '07:45',
    lastPunchType: 'IN',
    speedKmH: 0,
  ...
  },
  {
    ...
    vehicleRef: 'Peugeot Boxer (215 TN 1092)',
    status: 'EN_DEPLACEMENT',
    lat: 34.7405,
    lng: 10.7603,
    address: 'Route de Gabès Km 4, Sfax',
    siteOrClientName: 'En route vers Grossiste El Baraka',
    batteryLevel: 45,
    lastPunchTime: '09:10',
  ...
  },
  {
    ...
    role: 'Technicien de Maintenance Itinérant',
    vehicleRef: 'Citroën Berlingo (201 TN 6621)',
    status: 'HORS_ZONE',
    lat: 36.4512,
    lng: 10.7354,
    address: 'Route Nationale 1, Nabeul Nord',
    siteOrClientName: 'Périmètre Prévu: Usine Agro Nabeul',
    batteryLevel: 22,
    lastPunchTime: '08:30',
    lastPunchType: 'IN',
    speedKmH: 12,
    geofenceRadiusMeters: 150,
    distanceFromSiteMeters: 1450, // Hors périmètre
  ...
  },
  {
    ...
    role: 'Inspectrice Qualité Terrain',
    vehicleRef: 'Renault Clio (228 TN 3301)',
    status: 'SUR_SITE',
    lat: 37.2744,
    lng: 9.8739,
    address: 'Parc d\'Activités Européen, Bizerte',
    siteOrClientName: 'Site Industriel Bizerte Menzel Bourguiba',
    batteryLevel: 91,
    lastPunchTime: '08:00',
    lastPunchType: 'IN',
    speedKmH: 0,
