...
const DEMO_INCIDENTS: IncidentRecord[] = [
  { 
    ...
    safetyInquiry: "Le chauffeur prétend avoir été surpris par le freinage brusque du tiers. L'enquête démontre un manque de distance de sécurité réglementaire lors de l'impact pluvieux. Constat amiable rédigé.", 
    sanctionsApplied: "Avertissement verbal sérieux rappelé lors de la notice d'exploitation routière. Pas de responsabilité pécuniaire directe retenue mais surveillance des trajets planifiés.", 
    severity: 'Medium', 
    status: 'Resolved' 
  },
  { 
    ...
    sanctionsApplied: 'En attente de commission de sécurité interne. Optionnelle retenue sur prime de déplacement pour négligence de stationnement sous réserve de consultation du PV de sécurité Tunis-Port.', 
    severity: 'Low', 
    status: 'UnderInquiry' 
  }
];
...
export default function FleetManager({ 
  ...
  // Double-secure UI level fallbacks to prevent any hydration flickering of demo data
