...
export const INITIAL_PRODUCTS: Product[] = [
  // --- 1. PRODUITS FINIS & MARCHANDISES DE REVENTE ---
  {
    id: "PROD-CIM-50",
    ...
    stockLevel: 1200,
    minStockLevel: 300,
    unitPrice: 14.500, // PV HT
    costPrice: 11.200, // PA HT
    supplierId: "sup_btp_1",
  ...
  // --- 2. MATIÈRES PREMIÈRES & COMPOSANTS ---
  {
    ...
    stockLevel: 850,
    minStockLevel: 500, // Low threshold triggers DA!
    unitPrice: 24.500,
    costPrice: 24.500,
    supplierId: "sup_raw_1",
