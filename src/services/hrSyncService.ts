...
export const DEMO_HR_EMPLOYEES: Employee[] = [
  ...
  },
  {
    ...
    jobTitle: 'Chargé Clientèle / Commercial Centre',
  ...
  },
  {
    ...
    jobTitle: 'Responsable Ressources Humaines & Paie',
  ...
  },
  {
    ...
    jobTitle: 'Développeur ERP Principal / DSI',
    department: 'IT / DSI',
    pole: 'DIRECTION_IT',
    branchId: 'loc-siege-tunis',
    ssn: '11049382-77',
...
export const DEMO_HR_WORK_CONTRACTS: WorkContract[] = [
  {
    id: 'ct-demo-0',
    tenantId: 'company_demo',
    ...
    baseSalary: 4500.000,
    status: 'Signed',
    dutiesDescription: 'Direction Générale, stratégie groupe Elyssa ERP, pilotage financier et gouvernance multi-sites.',
  ...
  },
  {
    ...
    baseSalary: 2600.000,
    status: 'Signed',
    dutiesDescription: 'Direction Financière, gestion de trésorerie, déclarations fiscales/sociales et pilotage du recouvrement B2B.',
  ...
  },
  {
    ...
    baseSalary: 1750.000,
    status: 'Signed',
    dutiesDescription: 'Comptabilité générale, rapprochement bancaire quotidien, suivi des comptes fournisseurs et règlements.',
  ...
  },
  {
    ...
    baseSalary: 1400.000,
    status: 'Signed',
    dutiesDescription: 'Développement commercial, prospection terrain Sahel/Centre, suivi du portefeuille clients et saisie des commandes.',
    generatedAt: '2025-06-18',
    signedAt: '2025-06-19'
  },
  {
    id: 'ct-demo-4',
    ...
    baseSalary: 2100.000,
    status: 'Signed',
    dutiesDescription: 'Responsable RH, établissement de la paie, gestion des déclarations CNSS/IRPP, suivi des congés et du pointage.',
  ...
  },
  {
    ...
    baseSalary: 3200.000,
    status: 'Signed',
    dutiesDescription: 'Architecture technique, développement et maintenance de la suite ERP, gestion de l\'infrastructure cloud.',
  ...
  },
  {
    ...
    baseSalary: 1450.000,
    status: 'Signed',
    dutiesDescription: 'Chauffeur livreur poids lourd / utilitaire, acheminement des marchandises multi-agences et respect des tournées.',
...
export function autoCreateOrUpdatePerformanceContract(emp: Employee, tenantId: string): PerformanceContract {
  ...
  const primeTarget = Math.round(baseSal * 0.2);
  const calculatedPrime = Math.round(primeTarget * 0.909);

  const contract: PerformanceContract = {
    id: `mpo_${emp.id}_${currentYear}`,
    tenantId: tenantId || emp.tenantId || 'company_parent',
    employee_id: emp.id,
    ...
    achievement_rate: 90.9,
    tripartite_breakdown: {
      weight_entreprise: 70,
      rate_entreprise: 90,
      prime_entreprise: Math.round(primeTarget * 0.7 * 0.9),
      weight_direction: 20,
      rate_direction: 92,
      prime_direction: Math.round(primeTarget * 0.2 * 0.92),
      weight_personnel: 10,
      rate_personnel: 95,
      prime_personnel: Math.round(primeTarget * 0.1 * 0.95),
      formula_string: "(70% × 90%) + (20% × 92%) + (10% × 95%) = 90.9%"
    },
    kpis: kpiItems,
  ...
  try {
    const storageKey = `carthage_mpo_contracts_${tenantId || 'company_parent'}`;
